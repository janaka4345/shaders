  ...
  const SeaShaderMaterial = shaderMaterial(
    {
      ...
      uUpColor: new Color(parameters.upColor),
      uDownColor: new Color(parameters.downColor),
    },
    // vertex shader
    /*glsl*/ `
        varying vec2 vUv;
    ...
    /*glsl*/ `
        ...
        void main() {
          ...
          vec3 color=mix(uDownColor,uUpColor,vElevation*5.0+0.5);//add  thos to leva too
